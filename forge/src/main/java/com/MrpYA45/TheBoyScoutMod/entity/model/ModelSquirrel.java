...
public class ModelSquirrel<T extends Entity> extends EntityModel<T> {
	// fields
	RendererModel Cuerpo_Principal;
	RendererModel Cabeza;
	RendererModel Pie_1;
	RendererModel Pie_2;
	RendererModel Cola_Parte_2;
	RendererModel Cola_Parte_1;
	RendererModel Cala_Parte_3;
	RendererModel Oreja_1;
	RendererModel Oreja_2;
	RendererModel Brazo_1;
	RendererModel Brazo_2;

	public ModelSquirrel() {
		textureWidth = 64;
		textureHeight = 32;

		Cuerpo_Principal = new RendererModel(this, 14, 0);
		...
		Cola_Parte_1 = new RendererModel(this, 46, 0);
		...
		Cala_Parte_3 = new RendererModel(this, 60, 0);
		...
		Oreja_1 = new RendererModel(this, 0, 9);
		...
		Oreja_2 = new RendererModel(this, 6, 9);
		...
		Brazo_1 = new RendererModel(this, 54, 28);
		...
		Brazo_2 = new RendererModel(this, 60, 28);
