...
public class BlockDiamondBox extends BlockBase implements ITileEntityProvider {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, BlockState state, PlayerEntity playerIn, Hand hand, Direction facing, float hitX, float hitY, float hitZ) {
		TileEntityDiamondBox te = (TileEntityDiamondBox) worldIn.getTileEntity(pos);
    ...
    public void breakBlock(World world, BlockPos pos, BlockState state) {
    	TileEntityDiamondBox te = (TileEntityDiamondBox) world.getTileEntity(pos);
