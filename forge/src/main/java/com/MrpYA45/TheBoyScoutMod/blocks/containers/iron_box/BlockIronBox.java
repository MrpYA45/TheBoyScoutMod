...
public class BlockIronBox extends BlockBase implements ITileEntityProvider {

	public BlockIronBox(String name) {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		TileEntityIronBox te = (TileEntityIronBox) worldIn.getTileEntity(pos);
    ...
    public void breakBlock(World world, BlockPos pos, IBlockState state) {
    	TileEntityIronBox te = (TileEntityIronBox) world.getTileEntity(pos);
