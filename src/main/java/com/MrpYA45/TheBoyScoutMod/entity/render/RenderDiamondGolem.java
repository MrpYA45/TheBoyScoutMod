...
public class RenderDiamondGolem extends RenderLiving<EntityDiamondGolem> {
	...
	public static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/entity/golem_diamond.png");
	...
	@Override
	protected void applyRotations(EntityDiamondGolem entityLiving, float p_77043_2_, float rotationYaw, float partialTicks)
	{
