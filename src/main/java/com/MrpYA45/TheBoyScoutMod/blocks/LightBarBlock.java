...
public class LightBarBlock extends BlockLadder implements IHasModel {
	...
	public LightBarBlock(String name, Material material, float hardness, float resistance, SoundType soundtype) {
