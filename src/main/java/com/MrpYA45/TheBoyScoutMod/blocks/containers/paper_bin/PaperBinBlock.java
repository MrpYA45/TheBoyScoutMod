...
public class PaperBinBlock extends BlockHorizontal implements ITileEntityProvider {

	public PaperBinBlock(String name, Material material, float hardness, float resistance, SoundType soundtype) {
		super(material);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		PaperBinTileEntity te = (PaperBinTileEntity) worldIn.getTileEntity(pos);
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random random) {
         ...
         if (true) {
              {
                   TileEntity te = worldIn.getTileEntity(new BlockPos(i, j, k));
                   if (te != null && (te instanceof PaperBinTileEntity))
                        ((PaperBinTileEntity) te).decrStackSize(0, 64);
              }
         }
    ...
    public void breakBlock(World world, BlockPos pos, IBlockState state) {
    	PaperBinTileEntity te = (PaperBinTileEntity) world.getTileEntity(pos);
