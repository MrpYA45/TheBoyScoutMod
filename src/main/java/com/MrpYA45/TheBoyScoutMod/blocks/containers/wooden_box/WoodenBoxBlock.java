...
public class WoodenBoxBlock extends BlockBase implements ITileEntityProvider {

	public WoodenBoxBlock(String name) {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		WoodenBoxTileEntity te = (WoodenBoxTileEntity) worldIn.getTileEntity(pos);
    ...
    public void breakBlock(World world, BlockPos pos, IBlockState state) {
    	WoodenBoxTileEntity te = (WoodenBoxTileEntity) world.getTileEntity(pos);
