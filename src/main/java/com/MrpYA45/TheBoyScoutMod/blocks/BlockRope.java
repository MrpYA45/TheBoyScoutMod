...
public class BlockRope extends Block implements IHasModel {
    ...
    private boolean canAttachTo(World worldIn, BlockPos pos, EnumFacing facing) {
        ...
        return (!flag && iblockstate.getBlockFaceShape(worldIn, pos, facing) == BlockFaceShape.SOLID && !iblockstate.canProvidePower()) || iblockstate.getBlock() instanceof BlockRope;
    }
