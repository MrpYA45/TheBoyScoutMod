...
public class BlockHandheldLanternOn extends BlockHandheldLantern implements IHasModel {

	public BlockHandheldLanternOn(String name, Material material, float hardness, float resistance, SoundType soundtype) {
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		int k = pos.getZ();
		if (true) {
			EnumFacing rot = world.getBlockState(pos).getValue(BlockHandheldLanternOn.FACING);
